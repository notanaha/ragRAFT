...
def main():
    ...
    query = st.text_input("Enter your question:", value="PCS警告灯が点滅または点灯する場合はどうすればよいですか？")
    ...
    if st.button("Enter", key="confirm"):
        ...
        if 'messages' not in st.session_state:
            ...
            #--------------------------------------#
            with open(os.path.join('utilities','100_businessSupport_sys_msg01.txt'), "r", encoding = 'utf-8') as f:
        ...
        response_message, messages, ft_content = call_gpt4(messages, tools=tools, tool_choice='auto', user_context=query)
